...
class _BasicTestRunWidgetState extends State<BasicTestRunWidget> {
  ...
  Future<void> wholeApiDefinition() async {
    ...
    // global attributes
    SplunkRum.instance.globalAttributes.get(key: "my_key");
    SplunkRum.instance.globalAttributes.getAll();
    SplunkRum.instance.globalAttributes.remove(key: "old_key");
    SplunkRum.instance.globalAttributes.removeAll();
    SplunkRum.instance.globalAttributes.contains(key: "existing_key");
    SplunkRum.instance.globalAttributes.setString(
      key: "user_name",
      value: "Alice",
    );
    SplunkRum.instance.globalAttributes.setInt(key: "user_id", value: 123);
