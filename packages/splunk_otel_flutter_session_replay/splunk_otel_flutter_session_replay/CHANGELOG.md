...
* Pinned a direct dependency on the core `splunk_otel_flutter` package to the matching minor line (`>=1.1.0 <1.2.0`) so session replay and core always resolve to compatible versions.
